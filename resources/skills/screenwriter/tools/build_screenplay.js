...
//   2. Inside the `screenplay` array, write your scenes via the helpers (slug/action/character/dial etc.).
...
//   Courier New 12pt (monospaced → 1 page ≈ 1 minute of screen time for mixed dialogue/action)
...
// Turn on automatic scene numbering. Set the starting number if the block does not start at 1.
...
const screenplay = [
  ...
  // Sample scene — replace with your own.
  slug("EXT. LOCATION — TIME OF DAY"),
  action("Description of what is visible in the shot. Action verbs only."),
  action("A second action, if needed."),

  character("HERO"),
  dial("The hero's dialogue line."),
