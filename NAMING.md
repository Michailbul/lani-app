...
- One word, ownable, easy to say, easy to type
- No baggage with existing dev or writing tools
- Pairs well with studio brand language (Coral, Carbon, Ember)

## Alternatives considered

- **Reel** — parallel reels of film. Equally legible, slightly more crowded as a name.
...
- Carbon `#191919` background
- Ember `#FF8C42` for primary action / "merge to main"
- Linen `#FFF4EA` for the script surface
- DG (display) for app chrome, JB Mono for branch names, body face TBD with the editor pick
