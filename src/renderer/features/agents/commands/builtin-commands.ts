...
2. Create the file .lani/worktree.json with setup commands
...
Example output for .lani/worktree.json:
{
  "setup-worktree": [
    "bun install",
...
Now analyze this project and create .lani/worktree.json with the appropriate setup commands.`,
}
