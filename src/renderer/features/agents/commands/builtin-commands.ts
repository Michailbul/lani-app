...
2. Create the file .backlot/worktree.json with setup commands
...
Example output for .backlot/worktree.json:
{
  "setup-worktree": [
    "bun install",
...
Now analyze this project and create .backlot/worktree.json with the appropriate setup commands.`,
}
