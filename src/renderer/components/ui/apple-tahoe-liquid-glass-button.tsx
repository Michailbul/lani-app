...
// The ultra-optimized WebP normal map from the reference. Exported so
// other surfaces (the workflow dock thumb) can reuse the same refraction
// without duplicating the 30KB payload.
export const WEBP_DISPLACEMENT_MAP =
